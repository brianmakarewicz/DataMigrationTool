-- PACKAGE DMT_1099_FBDI_GEN_PKG

  CREATE OR REPLACE EDITIONABLE PACKAGE "DMT_1099_FBDI_GEN_PKG" 
AUTHID DEFINER
AS
-- ============================================================
-- DMT_1099_FBDI_GEN_PKG
-- Generates the 1099 Invoices FBDI zip from TFM staging records.
--
-- Shares AP Invoice staging/TFM tables with APInvoices.
-- Differentiated by INVOICE_TYPE_LOOKUP_CODE LIKE '%1099%'.
--
