-- PACKAGE BODY DMT_GL_CALENDAR_VALIDATOR_PKG

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DMT_GL_CALENDAR_VALIDATOR_PKG" AS
-- ============================================================
-- DMT_GL_CALENDAR_VALIDATOR_PKG Body
-- ============================================================

    C_PKG CONSTANT VARCHAR2(50) := 'DMT_GL_CALENDAR_VALIDATOR_PKG';

    -- --------------------------------------------------------
    -- VALIDATE_PRE_TRANSFORM
    -- Upstream dependency check before transformation.
    -- GL Calendar has no upstream dependencies — stub.
    -- --------------------------------------------------------
    -- ============================================================
    ...
    BEGIN
        ...
        -- GL Calendar is standalone master data with no upstream dependencies.
        NULL;
    ...
    -- Checks: PERIOD_SET_NAME not null, START_DATE <= END_DATE.
    -- --------------------------------------------------------
