...
-- ============================================================
    ...
    BEGIN
        ...
        SELECT
                    ...
                    s.DESCRIPTION,
                    DMT_XREF_PKG.PO_NUMBER(s.EMERGENCY_PO_NUMBER),
    ...
    BEGIN
        ...
        SELECT
                    ...
                    s.ITEM_REVISION,
                    DMT_XREF_PKG.UOM_CODE(s.UOM_CODE),
                    s.LINE_TYPE,
                    s.QUANTITY,
                    s.CURRENCY_CODE,
                    ...
                    DMT_XREF_PKG.SUPPLIER_NAME(s.SUGGESTED_VENDOR_NAME),
                    ...
                    s.ATTRIBUTE_NUMBER6,  s.ATTRIBUTE_NUMBER7,  s.ATTRIBUTE_NUMBER8,  s.ATTRIBUTE_NUMBER9,  s.ATTRIBUTE_NUMBER10,
                    s.ATTRIBUTE_CATEGORY,
                    DMT_XREF_PKG.SUPPLIER_NUMBER(s.VENDOR_NUMBER),
