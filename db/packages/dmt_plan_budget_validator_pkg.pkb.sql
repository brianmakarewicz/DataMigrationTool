-- PACKAGE BODY DMT_PLAN_BUDGET_VALIDATOR_PKG

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DMT_PLAN_BUDGET_VALIDATOR_PKG" AS
    C_PKG CONSTANT VARCHAR2(50) := 'DMT_PLAN_BUDGET_VALIDATOR_PKG';
...
END DMT_PLAN_BUDGET_VALIDATOR_PKG;
/
