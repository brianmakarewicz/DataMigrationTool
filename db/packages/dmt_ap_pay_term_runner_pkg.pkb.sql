...
-- ============================================================
    ...
    -- Payment Terms has no scenario filter (its STG rows are scenario-tagged by
    -- the seed and consumed by RUN_ID) and no business-unit refresh, so the
    -- extra arguments are accepted for contract conformance and ignored;
    -- delegates straight to RUN.
    -- ============================================================
