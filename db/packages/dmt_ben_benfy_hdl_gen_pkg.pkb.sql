...
-- BeneficiaryDesignation HDL DAT generation.
--
-- V2 fixes applied:
...
--   - SourceSystemId uses PERSON_NUMBER || '_BENBNFY' convention
-- ============================================================
    ...
    -- BeneficiaryBenefitBalance is NOT a valid discriminator — use PersonBenefitBalance
    C_BENEFICIARYDESIGNATION_COLS CONSTANT VARCHAR2(4000) :=
    ...
    BEGIN
        ...
        x_filename := 'BeneficiaryDesignations_' || TO_CHAR(p_run_id) || '.zip';

        DBMS_LOB.CREATETEMPORARY(l_dat, TRUE);


        -- ============================================================
        -- 1. BeneficiaryDesignation
        -- ============================================================
        IF has_rows('DMT_BEN_BENFY_TFM_TBL', p_run_id) THEN
            DBMS_LOB.WRITEAPPEND(l_dat, LENGTH(DMT_HDL_UTIL_PKG.BUILD_DAT_HEADER('PersonBenefitBalance', C_BENEFICIARYDESIGNATION_COLS)),
                DMT_HDL_UTIL_PKG.BUILD_DAT_HEADER('PersonBenefitBalance', C_BENEFICIARYDESIGNATION_COLS));
        ...
        INSERT INTO DMT_OWNER.DMT_FBDI_CSV_TBL (
            ...
            l_csv_id, p_run_id, 'BeneficiaryDesignations',
