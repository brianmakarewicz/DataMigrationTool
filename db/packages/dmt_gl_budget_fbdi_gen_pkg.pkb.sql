...
-- ============================================================
    ...
    BEGIN
        ...
        IF DBMS_LOB.GETLENGTH(l_csv) > 0 THEN
            DMT_OWNER.UTL_ZIP.add1file(l_zip, 'GlBudgetInterface.csv',
                clob_to_blob(l_csv));
        END IF;
        ...
        VALUES (l_fbdi_csv_id, p_run_id, 'GLBudgetBalances', x_filename, l_row_count, l_csv, l_now);
        ...
        VALUES (DMT_OWNER.DMT_FBDI_ZIP_ID_SEQ.NEXTVAL, l_fbdi_csv_id, p_run_id, 'GLBudgetBalances', x_filename, DBMS_LOB.GETLENGTH(l_zip), l_zip, l_now);
