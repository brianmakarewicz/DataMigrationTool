-- PACKAGE BODY DMT_BEN_DEPEND_VALIDATOR_PKG

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DMT_BEN_DEPEND_VALIDATOR_PKG" 
AS
-- ============================================================
-- DMT_BEN_DEPEND_VALIDATOR_PKG body
-- Stub -- no rules implemented yet.
-- ============================================================

    C_PKG CONSTANT VARCHAR2(50) := 'DMT_BEN_DEPEND_VALIDATOR_PKG';
    ...
    BEGIN
        ...
        UPDATE DMT_OWNER.DMT_BEN_DEPEND_STG_TBL
        ...
        -- <<EDIT-SCOPE — this table's SUB_OBJECT>>
                                   AND SUB_OBJECT = 'Dependent Enrollment'
...
END DMT_BEN_DEPEND_VALIDATOR_PKG;
/
