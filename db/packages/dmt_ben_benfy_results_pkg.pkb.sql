...
-- BeneficiaryDesignation HDL reconciliation via DMT_HDL_UTIL_PKG.
-- ============================================================

    C_PKG   CONSTANT VARCHAR2(50) := 'DMT_BEN_BENFY_RESULTS_PKG';
    C_CEMLI CONSTANT VARCHAR2(30) := 'BeneficiaryDesignations';
    ...
    BEGIN
        ...
        -- Post-reconciliation: capture the Fusion beneficiary id on each
        -- LOADED row (design section 7 rule). Blocked object today.
        DMT_HDL_UTIL_PKG.LOOKUP_FUSION_IDS(
            p_run_id => p_run_id,
            p_object_type    => 'BenefitsBeneficiary',
            p_log_context    => C_CEMLI || ' > BeneficiaryDesignation');
