...
-- ============================================================
    ...
    BEGIN
        ...
        SELECT
                    s.STG_SEQUENCE_ID, p_run_id, DMT_UTIL_PKG.PREFIXED(l_prefix, s.AWARD_NUMBER, 120), DMT_XREF_PKG.PROJECT_NUMBER(s.PROJECT_NUMBER), s.TASK_NUMBER, s.BURDEN_SCHEDULE, s.FIXED_DATE
