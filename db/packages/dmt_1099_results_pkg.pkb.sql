-- PACKAGE BODY DMT_1099_RESULTS_PKG

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DMT_1099_RESULTS_PKG" 
AS
-- ============================================================
-- DMT_1099_RESULTS_PKG body
-- 1099Invoices BIP reconciliation.
-- Pattern: identical to DMT_AP_RESULTS_PKG but with C_CEMLI = '1099Invoices'.
-- Shares AP Invoice staging/TFM tables.
-- ============================================================

    C_PKG   CONSTANT VARCHAR2(50) := 'DMT_1099_RESULTS_PKG';
    C_CEMLI CONSTANT VARCHAR2(30) := '1099Invoices';

    -- --------------------------------------------------------
    -- Private: POST a SOAP envelope; return full response CLOB.
    -- (Same helper as AP/PO/supplier results â€” duplicated to keep packages independent.)
    -- --------------------------------------------------------
