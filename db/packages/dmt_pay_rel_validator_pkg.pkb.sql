-- PACKAGE BODY DMT_PAY_REL_VALIDATOR_PKG

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DMT_PAY_REL_VALIDATOR_PKG" 
AS
-- ============================================================
-- DMT_PAY_REL_VALIDATOR_PKG body
-- Stub -- no rules implemented yet.
-- ============================================================

    C_PKG CONSTANT VARCHAR2(50) := 'DMT_PAY_REL_VALIDATOR_PKG';
    ...
    BEGIN
        ...
        -- <<EDIT-SCOPE — this table's SUB_OBJECT>>
                                   AND SUB_OBJECT = 'Payroll Relationships'
