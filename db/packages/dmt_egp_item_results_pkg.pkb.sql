...
-- ============================================================
    ...
    BEGIN
        ...
        --   literal '[RECONCILE_ERROR] ' tag.>>
                   '[RECONCILE_ERROR] Item not confirmed in Fusion (not found in the '
                   || 'EGP_SYSTEM_ITEMS_B base table) after reconciliation; import outcome '
    ...
    BEGIN
        ...
        ELSE
            ...
            DMT_UTIL_PKG.LOG(p_run_id,
                'Items load FAILED. ESS=' || l_fusion_status || ', rows marked FAILED=' || l_count,
                C_PKG, C_PROC, 'WARN');
        END IF;
