...
-- ============================================================
    ...
    BEGIN
        ...
        INSERT INTO DMT_EGP_ITEM_TFM_TBL (
                    STG_SEQUENCE_ID,
                    RUN_ID,
                    -- Identity
                    TRANSACTION_TYPE,
        ...
        SELECT
                    ...
                    s.DESCRIPTION,
                    s.LONG_DESCRIPTION,
                    DMT_XREF_PKG.UOM_CODE(s.PRIMARY_UOM_CODE),
                    DMT_XREF_PKG.UOM_CODE(s.SECONDARY_UOM_CODE),
                    s.ITEM_TYPE,
                    s.ITEM_CLASS_NAME,
                    ...
                    -- Physical
                    s.UNIT_WEIGHT,
                    DMT_XREF_PKG.UOM_CODE(s.WEIGHT_UOM_CODE),
                    s.UNIT_VOLUME,
                    DMT_XREF_PKG.UOM_CODE(s.VOLUME_UOM_CODE),
                    DMT_XREF_PKG.UOM_CODE(s.DIMENSION_UOM_CODE),
                    s.UNIT_LENGTH,
                    s.UNIT_WIDTH,
                    s.UNIT_HEIGHT,
                    -- Purchasing
        ...
        AND NOT EXISTS (
            SELECT 1 FROM DMT_EGP_ITEM_TFM_TBL t
