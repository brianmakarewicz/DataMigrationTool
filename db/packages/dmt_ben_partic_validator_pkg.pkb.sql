-- PACKAGE BODY DMT_BEN_PARTIC_VALIDATOR_PKG

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DMT_BEN_PARTIC_VALIDATOR_PKG" 
AS
-- ============================================================
-- DMT_BEN_PARTIC_VALIDATOR_PKG body
-- Stub -- no rules implemented yet.
-- ============================================================

    C_PKG CONSTANT VARCHAR2(50) := 'DMT_BEN_PARTIC_VALIDATOR_PKG';
    ...
    BEGIN
        ...
        -- <<EDIT-SCOPE — this table's SUB_OBJECT>>
                                   AND SUB_OBJECT = 'Participant Enrollment'
