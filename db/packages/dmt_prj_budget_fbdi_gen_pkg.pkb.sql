...
-- ============================================================
    ...
    BEGIN
        ...
        DMT_OWNER.UTL_ZIP.add1file(l_zip, 'PjoPlanVersionsXface.csv',
            clob_to_blob(l_csv));
        ...
        VALUES (l_fbdi_csv_id, p_run_id, 'ProjectBudgets', x_filename, 0, l_csv, l_now);
        ...
        VALUES (DMT_OWNER.DMT_FBDI_ZIP_ID_SEQ.NEXTVAL, l_fbdi_csv_id, p_run_id, 'ProjectBudgets', x_filename, DBMS_LOB.GETLENGTH(l_zip), l_zip, l_now);
