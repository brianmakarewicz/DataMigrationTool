...
-- ============================================================
    ...
    BEGIN
        ...
        -- WorkSchedule
        INSERT INTO DMT_WORK_SCHED_TFM_TBL (
            TFM_SEQUENCE_ID,
            STG_SEQUENCE_ID,
            RUN_ID,
            FBDI_CSV_ID,
        ...
        SELECT
            DMT_WORK_SCHED_TFM_SEQ.NEXTVAL,
            s.STG_SEQUENCE_ID,
            p_run_id,
            NULL,
        ...
        -- WorkScheduleShift
        INSERT INTO DMT_WORK_SCHED_DTL_TFM_TBL (
            TFM_SEQUENCE_ID,
            STG_SEQUENCE_ID,
            RUN_ID,
            FBDI_CSV_ID,
        ...
        SELECT
            DMT_WORK_SCHED_DTL_TFM_SEQ.NEXTVAL,
            s.STG_SEQUENCE_ID,
            p_run_id,
            NULL,
            s.WORK_SCHEDULE_NAME,
        ...
        UPDATE DMT_WORK_SCHED_DTL_STG_TBL
        SET    STG_STATUS = 'TRANSFORMED', LAST_UPDATED_DATE = SYSDATE
        WHERE  STG_SEQUENCE_ID IN (
            SELECT STG_SEQUENCE_ID
            FROM   DMT_WORK_SCHED_DTL_TFM_TBL
            WHERE  RUN_ID = p_run_id
        )
        AND (
            (p_run_mode = 'NEW' AND STG_STATUS IN ('NEW', 'RETRY'))
