...
-- ============================================================
    ...
    BEGIN
        ...
        INSERT INTO DMT_OWNER.DMT_W2_BAL_TFM_TBL (
            TFM_SEQUENCE_ID,
            STG_SEQUENCE_ID,
            RUN_ID,
            FBDI_CSV_ID,
        ...
        SELECT
            DMT_OWNER.DMT_W2_BAL_TFM_SEQ.NEXTVAL,
            s.STG_SEQUENCE_ID,
            p_run_id,
            NULL,
            ...
            'STAGED',
            SYSDATE
        FROM DMT_OWNER.DMT_W2_BAL_STG_TBL s
        WHERE (
        ...
        UPDATE DMT_OWNER.DMT_W2_BAL_STG_TBL
        ...
        INSERT INTO DMT_OWNER.DMT_W2_BAL_DTL_TFM_TBL (
            TFM_SEQUENCE_ID,
            STG_SEQUENCE_ID,
            RUN_ID,
            FBDI_CSV_ID,
        ...
        SELECT
            DMT_OWNER.DMT_W2_BAL_DTL_TFM_SEQ.NEXTVAL,
            s.STG_SEQUENCE_ID,
            p_run_id,
            NULL,
            DMT_UTIL_PKG.PREFIXED(l_prefix, s.PERSON_NUMBER, 30),
            ...
            'STAGED',
            SYSDATE
        FROM DMT_OWNER.DMT_W2_BAL_DTL_STG_TBL s
        WHERE (
            (p_run_mode = 'NEW' AND s.STG_STATUS IN ('NEW', 'RETRY'))
            OR (p_run_mode = 'FAILED' AND s.STG_STATUS = 'FAILED')
            OR (p_run_mode = 'ALL')
        ...
        UPDATE DMT_OWNER.DMT_W2_BAL_DTL_STG_TBL
        SET    STG_STATUS = 'TRANSFORMED', LAST_UPDATED_DATE = SYSDATE
        WHERE  STG_SEQUENCE_ID IN (
            SELECT STG_SEQUENCE_ID
