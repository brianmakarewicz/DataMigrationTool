-- PACKAGE BODY DMT_TAX_CARD_VALIDATOR_PKG

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DMT_TAX_CARD_VALIDATOR_PKG" 
AS
-- ============================================================
-- DMT_TAX_CARD_VALIDATOR_PKG body
-- Stub -- no rules implemented yet.
-- ============================================================

    C_PKG CONSTANT VARCHAR2(50) := 'DMT_TAX_CARD_VALIDATOR_PKG';
    ...
    BEGIN
        ...
        AND    STG_SEQUENCE_ID IN (SELECT STG_SEQUENCE_ID FROM DMT_OWNER.DMT_STG_TFM_ERROR_TBL
                                   WHERE RUN_ID = p_run_id
        -- <<EDIT-SCOPE>>
                                   AND SUB_OBJECT = 'Tax Card Components'
        -- <<END EDIT-SCOPE>>
                                  );
    END FLAG_STG_FAILED;
