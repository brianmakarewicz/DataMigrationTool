-- PACKAGE BODY DMT_POZ_SUP_SITE_VALIDATOR_PKG

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "DMT_POZ_SUP_SITE_VALIDATOR_PKG" AS
...
-- Add validation rules here without changing the orchestration flow.
    ...
    BEGIN
        DMT_UTIL_PKG.LOG(p_run_id,
            ...
            'INFO', 'DMT_POZ_SUP_SITE_VALIDATOR_PKG', 'VALIDATE_PRE_TRANSFORM');
    ...
    EXCEPTION
        WHEN OTHERS THEN
            DMT_UTIL_PKG.LOG_ERROR(p_run_id,
                ...
                'DMT_POZ_SUP_SITE_VALIDATOR_PKG', 'VALIDATE_PRE_TRANSFORM');
            RAISE;
    END VALIDATE_PRE_TRANSFORM;

END DMT_POZ_SUP_SITE_VALIDATOR_PKG;
/
