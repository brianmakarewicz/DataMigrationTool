...
-- ============================================================
    ...
    BEGIN
        ...
        UPDATE DMT_OWNER.DMT_GL_BUDGET_INT_STG_TBL SET STATUS='LOADED', LAST_UPDATED_DATE=SYSDATE
        ...
        UPDATE DMT_OWNER.DMT_GL_BUDGET_INT_STG_TBL SET STATUS='FAILED', LAST_UPDATED_DATE=SYSDATE
        WHERE STG_SEQUENCE_ID IN (SELECT STG_SEQUENCE_ID FROM DMT_OWNER.DMT_GL_BUDGET_INT_TFM_TBL
