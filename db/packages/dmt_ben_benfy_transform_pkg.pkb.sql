...
-- ============================================================
    ...
    BEGIN
        ...
        INSERT INTO DMT_BEN_BENFY_TFM_TBL (
            TFM_SEQUENCE_ID,
            STG_SEQUENCE_ID,
            RUN_ID,
            FBDI_CSV_ID,
        ...
        SELECT
            ...
            -- RECON_KEY = the BeneficiaryEnrollment parent SourceSystemId written
            -- to the HDL .dat (DMT_BEN_BENFY_HDL_GEN_PKG: prefixed PERSON_NUMBER ||
            -- '_BENENRL'), and the value the BIP reconciliation report returns as
            -- RECORD_KEY. One key definition (Contract v1, design section 5).
            -- 2026-09-17 re-model: the object is BeneficiaryEnrollment (child
            -- DesignateBeneficiary), NOT PersonBenefitBalance; the key suffix is
            -- '_BENENRL', never the old collided '_BENBNFY'.
