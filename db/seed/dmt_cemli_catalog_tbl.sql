...
using (
    ...
    union all select 'PurchaseOrders', 'PO Lines', 'DMT_PO_LINES_INT_TFM_TBL', 'TFM_STATUS', 'INTERFACE_HEADER_KEY IN (SELECT INTERFACE_HEADER_KEY FROM DMT_PO_HEADERS_INT_TFM_TBL WHERE STYLE_DISPLAY_NAME = ''Purchase Order'')', 2 from dual
    ...
    union all select 'BlanketPOs', 'Blanket PO Lines', 'DMT_PO_LINES_INT_TFM_TBL', 'TFM_STATUS', 'INTERFACE_HEADER_KEY IN (SELECT INTERFACE_HEADER_KEY FROM DMT_PO_HEADERS_INT_TFM_TBL WHERE STYLE_DISPLAY_NAME = ''Blanket Purchase Agreement'')', 2 from dual
