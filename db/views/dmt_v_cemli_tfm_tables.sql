...
UNION ALL SELECT 'APInvoices',           'DMT_AP_INVOICES_INT_TFM_TBL',    'AP Invoice Headers',       1, 'TFM_STATUS', 'INVOICE_TYPE_LOOKUP_CODE NOT LIKE ''%1099%''' FROM DUAL
UNION ALL SELECT 'APInvoices',           'DMT_AP_INVOICE_LINES_INT_TFM_TBL','AP Invoice Lines',        2, 'TFM_STATUS', 'INVOICE_ID IN (SELECT INVOICE_ID FROM DMT_OWNER.DMT_AP_INVOICES_INT_TFM_TBL WHERE INVOICE_TYPE_LOOKUP_CODE NOT LIKE ''%1099%'' OR INVOICE_TYPE_LOOKUP_CODE IS NULL)' FROM DUAL
UNION ALL SELECT '1099Invoices',         'DMT_AP_INVOICES_INT_TFM_TBL',    '1099 Invoice Headers',     1, 'TFM_STATUS', 'INVOICE_TYPE_LOOKUP_CODE LIKE ''%1099%''' FROM DUAL
UNION ALL SELECT '1099Invoices',         'DMT_AP_INVOICE_LINES_INT_TFM_TBL','1099 Invoice Lines',      2, 'TFM_STATUS', 'INVOICE_ID IN (SELECT INVOICE_ID FROM DMT_OWNER.DMT_AP_INVOICES_INT_TFM_TBL WHERE INVOICE_TYPE_LOOKUP_CODE LIKE ''%1099%'')' FROM DUAL
