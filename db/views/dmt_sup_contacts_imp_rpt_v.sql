-- DMT_SUP_CONTACTS_IMP_RPT_V
CREATE OR REPLACE FORCE EDITIONABLE VIEW "DMT_SUP_CONTACTS_IMP_RPT_V" ("INTEGRATION_ID", "ORCHESTRATION_CODE", "RUN_STATUS", "START_DATE", "END_DATE", "PREFIX", "STG_SEQUENCE_ID", "TFM_SEQUENCE_ID", "VENDOR_NAME", "FIRST_NAME", "LAST_NAME", "EMAIL_ADDRESS", "PRIMARY_ADMIN_CONTACT", "USER_ACCOUNT_ACTION", "STG_STATUS", "TFM_STATUS", "EFFECTIVE_STATUS", "RECONCILIATION_STATUS", "STG_ERRORS", "TFM_ERRORS", "ALL_ERRORS", "FUSION_CONTACT_ID", "RESULTS_UPDATED_DATE", "STAGE_DATE", "SOURCE_RECORD_ID")  AS 
  SELECT
    t.INTEGRATION_ID,
...
FROM
    DMT_OWNER.DMT_POZ_SUP_CONTACTS_STG_TBL         s
    LEFT JOIN DMT_OWNER.DMT_POZ_SUP_CONTACTS_TFM_TBL t
