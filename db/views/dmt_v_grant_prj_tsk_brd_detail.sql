...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_V_GRANT_PRJ_TSK_BRD_DETAIL" ("RUN_STATUS", "ERROR_TEXT", "RECONCILIATION_STATUS", "AWARD_NUMBER", "PROJECT_NUMBER", "TASK_NUMBER", "BURDEN_SCHEDULE", "FIXED_DATE", "SOURCE_ID", "STG_SEQUENCE_ID", "RUN_ID", "INTEGRATION_ID", "PREFIX", "SCENARIO_ID", "STAGE_DATE", "LAST_UPDATED_DATE")  AS 
  SELECT
