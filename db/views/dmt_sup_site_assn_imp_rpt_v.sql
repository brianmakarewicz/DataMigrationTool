-- DMT_SUP_SITE_ASSN_IMP_RPT_V
CREATE OR REPLACE FORCE EDITIONABLE VIEW "DMT_SUP_SITE_ASSN_IMP_RPT_V" ("INTEGRATION_ID", "ORCHESTRATION_CODE", "RUN_STATUS", "START_DATE", "END_DATE", "PREFIX", "STG_SEQUENCE_ID", "TFM_SEQUENCE_ID", "VENDOR_NAME", "VENDOR_SITE_CODE", "PROCUREMENT_BUSINESS_UNIT_NAME", "BUSINESS_UNIT_NAME", "BILL_TO_BU_NAME", "STG_STATUS", "TFM_STATUS", "EFFECTIVE_STATUS", "RECONCILIATION_STATUS", "STG_ERRORS", "TFM_ERRORS", "ALL_ERRORS", "FUSION_ASSIGNMENT_ID", "RESULTS_UPDATED_DATE", "STAGE_DATE", "SOURCE_RECORD_ID")  AS 
  SELECT
    t.INTEGRATION_ID,
    ...
    t.FUSION_ASSIGNMENT_ID,
    t.RESULTS_UPDATED_DATE,
    s.STAGE_DATE,
    s.SOURCE_ID                                     AS SOURCE_RECORD_ID
FROM
    DMT_OWNER.DMT_POZ_SUP_SITE_ASSN_STG_TBL         s
    LEFT JOIN DMT_OWNER.DMT_POZ_SUP_SITE_ASSN_TFM_TBL t
