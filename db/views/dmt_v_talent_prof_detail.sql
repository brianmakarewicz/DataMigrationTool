...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_V_TALENT_PROF_DETAIL" ("RUN_STATUS", "ERROR_TEXT", "RECONCILIATION_STATUS", "PERSON_NUMBER", "PROFILE_CODE", "PROFILE_TYPE_CODE", "PROFILE_STATUS_CODE", "PROFILE_USAGE_CODE", "DESCRIPTION", "SOURCE_ID", "STG_SEQUENCE_ID", "RUN_ID", "PREFIX", "SCENARIO_ID", "STAGE_DATE", "LAST_UPDATED_DATE")  AS 
  SELECT
