...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_V_GRANT_PRJ_FUND_SRC_DETAIL" ("RUN_STATUS", "ERROR_TEXT", "RECONCILIATION_STATUS", "AWARD_NUMBER", "PROJECT_NUMBER", "FUNDING_SOURCE_NAME", "FUNDING_SOURCE_NUMBER", "ENABLE_BURDENING_FLAG", "SOURCE_ID", "STG_SEQUENCE_ID", "RUN_ID", "PREFIX", "SCENARIO_ID", "STAGE_DATE", "LAST_UPDATED_DATE")  AS 
  SELECT
