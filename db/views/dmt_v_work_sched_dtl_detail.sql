...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_V_WORK_SCHED_DTL_DETAIL" ("RUN_STATUS", "ERROR_TEXT", "RECONCILIATION_STATUS", "WORK_SCHEDULE_NAME", "SHIFT_NAME", "SHIFT_DATE", "START_TIME", "END_TIME", "DURATION", "UNIT_OF_MEASURE", "SOURCE_ID", "STG_SEQUENCE_ID", "RUN_ID", "INTEGRATION_ID", "PREFIX", "SCENARIO_ID", "STAGE_DATE", "LAST_UPDATED_DATE")  AS 
  SELECT
