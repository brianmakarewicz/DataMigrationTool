...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_V_GRANT_TERMS_DETAIL" ("RUN_STATUS", "ERROR_TEXT", "RECONCILIATION_STATUS", "AWARD_NUMBER", "TERM_CATEGORY_NAME", "TERM_NAME", "TERM_DESCRIPTION", "TERM_OPERAND", "TERM_VALUE", "SOURCE_ID", "STG_SEQUENCE_ID", "RUN_ID", "PREFIX", "SCENARIO_ID", "STAGE_DATE", "LAST_UPDATED_DATE")  AS 
  SELECT
