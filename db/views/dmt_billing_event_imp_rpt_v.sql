-- DMT_BILLING_EVENT_IMP_RPT_V
CREATE OR REPLACE FORCE EDITIONABLE VIEW "DMT_BILLING_EVENT_IMP_RPT_V" ("INTEGRATION_ID", "ORCHESTRATION_CODE", "RUN_STATUS", "START_DATE", "END_DATE", "PREFIX", "STG_SEQUENCE_ID", "TFM_SEQUENCE_ID", "SOURCENAME", "SOURCEREF", "PROJECT_NUMBER", "TASK_NUMBER", "EVENT_TYPE_NAME", "EVENT_DESC", "COMPLETION_DATE", "BILL_TRNS_CURRENCY_CODE", "BILL_TRNS_AMOUNT", "CONTRACT_NUMBER", "CONTRACT_LINE_NUMBER", "STG_STATUS", "TFM_STATUS", "EFFECTIVE_STATUS", "RECONCILIATION_STATUS", "STG_ERRORS", "TFM_ERRORS", "ALL_ERRORS", "RESULTS_UPDATED_DATE", "STAGE_DATE", "SOURCE_RECORD_ID")  AS 
  SELECT
    t.INTEGRATION_ID,
...
FROM
    DMT_OWNER.DMT_PJB_BILL_EVENTS_STG_TBL       s
    LEFT JOIN DMT_OWNER.DMT_PJB_BILL_EVENTS_TFM_TBL t
