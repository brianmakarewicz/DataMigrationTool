...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_V_PERF_EVAL_RATING_DETAIL" ("RUN_STATUS", "ERROR_TEXT", "RECONCILIATION_STATUS", "PERSON_NUMBER", "SECTION_NAME", "RATING_LEVEL_CODE", "COMMENTS", "REVIEW_PERIOD_NAME", "DOCUMENT_NAME", "SOURCE_ID", "STG_SEQUENCE_ID", "RUN_ID", "PREFIX", "SCENARIO_ID", "STAGE_DATE", "LAST_UPDATED_DATE")  AS 
  SELECT
