-- DMT_RUN_STATUS_V
CREATE OR REPLACE EDITIONABLE VIEW "DMT_RUN_STATUS_V" ("RUN_ID", "SCENARIO_ID", "PIPELINE_CODES", "PREFIX", "RUN_STATUS", "SUBMITTED_DATE", "COMPLETED_DATE", "OBJECT_TYPE", "TOTAL_ROWS", "LOADED_ROWS", "FAILED_ROWS", "GENERATED_ROWS", "OTHER_ROWS", "ZIP_FILENAME", "ZIP_SIZE_BYTES", "LOAD_ESS_JOB_ID", "IMPORT_ESS_JOB_ID", "POSTRUN_ESS_JOB_ID", "RECENT_LOGS")  AS 
  WITH tfm_summary AS (
