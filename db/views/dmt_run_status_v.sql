...
CREATE OR REPLACE FORCE EDITIONABLE VIEW "DMT_RUN_STATUS_V" ("RUN_ID", "INTEGRATION_ID", "SCENARIO_ID", "PIPELINE_CODES", "PREFIX", "RUN_STATUS", "SUBMITTED_DATE", "COMPLETED_DATE", "OBJECT_TYPE", "TOTAL_ROWS", "LOADED_ROWS", "FAILED_ROWS", "GENERATED_ROWS", "OTHER_ROWS", "ZIP_FILENAME", "ZIP_SIZE_BYTES", "LOAD_ESS_JOB_ID", "IMPORT_ESS_JOB_ID", "POSTRUN_ESS_JOB_ID", "RECENT_LOGS")  AS 
  WITH tfm_summary AS (
    ...
    SELECT RUN_ID,
           ...
           COUNT(*)              AS TOTAL_ROWS,
           SUM(CASE WHEN TFM_STATUS = 'LOADED'    THEN 1 ELSE 0 END) AS LOADED_ROWS,
           SUM(CASE WHEN TFM_STATUS = 'FAILED'    THEN 1 ELSE 0 END) AS FAILED_ROWS,
           SUM(CASE WHEN TFM_STATUS = 'GENERATED' THEN 1 ELSE 0 END) AS GENERATED_ROWS,
           SUM(CASE WHEN TFM_STATUS NOT IN ('LOADED','FAILED','GENERATED') THEN 1 ELSE 0 END) AS OTHER_ROWS
