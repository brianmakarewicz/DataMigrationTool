...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_V_TALENT_PROF_ITEM_DETAIL" ("RUN_STATUS", "ERROR_TEXT", "RECONCILIATION_STATUS", "PERSON_NUMBER", "CONTENT_TYPE_NAME", "CONTENT_ITEM_NAME", "DATE_FROM", "DATE_TO", "RATING", "PROFILE_CODE", "INTEREST_LEVEL", "SOURCE_ID", "STG_SEQUENCE_ID", "RUN_ID", "PREFIX", "SCENARIO_ID", "STAGE_DATE", "LAST_UPDATED_DATE")  AS 
  SELECT
