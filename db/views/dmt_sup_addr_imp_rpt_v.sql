-- DMT_SUP_ADDR_IMP_RPT_V
CREATE OR REPLACE FORCE EDITIONABLE VIEW "DMT_SUP_ADDR_IMP_RPT_V" ("INTEGRATION_ID", "ORCHESTRATION_CODE", "RUN_STATUS", "START_DATE", "END_DATE", "PREFIX", "STG_SEQUENCE_ID", "TFM_SEQUENCE_ID", "VENDOR_NAME", "PARTY_SITE_NAME", "COUNTRY", "ADDRESS_LINE1", "CITY", "STATE", "POSTAL_CODE", "STG_STATUS", "TFM_STATUS", "EFFECTIVE_STATUS", "RECONCILIATION_STATUS", "STG_ERRORS", "TFM_ERRORS", "ALL_ERRORS", "FUSION_PARTY_SITE_ID", "RESULTS_UPDATED_DATE", "STAGE_DATE", "SOURCE_RECORD_ID")  AS 
  SELECT
    t.INTEGRATION_ID,
...
FROM
    DMT_OWNER.DMT_POZ_SUP_ADDR_STG_TBL         s
    LEFT JOIN DMT_OWNER.DMT_POZ_SUP_ADDR_TFM_TBL t
