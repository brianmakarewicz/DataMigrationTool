...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_V_PERSON_PHONE_DETAIL" ("RUN_STATUS", "ERROR_TEXT", "RECONCILIATION_STATUS", "PERSON_NUMBER", "PHONE_TYPE", "EFFECTIVE_START_DATE", "EFFECTIVE_END_DATE", "COUNTRY_CODE_NUMBER", "AREA_CODE", "PHONE_NUMBER", "EXTENSION", "PRIMARY_FLAG", "FROM_DATE", "TO_DATE", "SOURCE_ID", "STG_SEQUENCE_ID", "RUN_ID", "PREFIX", "SCENARIO_ID", "STAGE_DATE", "LAST_UPDATED_DATE")  AS 
  SELECT
