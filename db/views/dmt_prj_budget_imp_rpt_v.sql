-- DMT_PRJ_BUDGET_IMP_RPT_V
CREATE OR REPLACE FORCE EDITIONABLE VIEW "DMT_PRJ_BUDGET_IMP_RPT_V" ("INTEGRATION_ID", "ORCHESTRATION_CODE", "RUN_STATUS", "START_DATE", "END_DATE", "PREFIX", "STG_SEQUENCE_ID", "TFM_SEQUENCE_ID", "FINANCIAL_PLAN_TYPE", "PROJECT_NAME", "PROJECT_NUMBER", "TASK_NAME", "PLAN_VERSION_NAME", "PLANNING_CURRENCY", "TOTAL_TC_RAW_COST", "TOTAL_TC_BRDND_COST", "TOTAL_TC_REVENUE", "SRC_BUDGET_LINE_REFERENCE", "STG_STATUS", "TFM_STATUS", "EFFECTIVE_STATUS", "RECONCILIATION_STATUS", "STG_ERRORS", "TFM_ERRORS", "ALL_ERRORS", "RESULTS_UPDATED_DATE", "STAGE_DATE", "SOURCE_RECORD_ID")  AS 
  SELECT
    t.INTEGRATION_ID,
...
FROM
    DMT_OWNER.DMT_PRJ_BUDGET_STG_TBL            s
    LEFT JOIN DMT_OWNER.DMT_PRJ_BUDGET_TFM_TBL  t
