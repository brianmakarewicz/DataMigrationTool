-- DMT_RECORD_DETAIL_V
CREATE OR REPLACE EDITIONABLE VIEW "DMT_RECORD_DETAIL_V" ("CEMLI_CODE", "SUB_OBJECT", "TFM_SEQUENCE_ID", "STG_SEQUENCE_ID", "RUN_ID", "INTEGRATION_ID", "DISPLAY_KEY", "LOOKUP_KEY", "TFM_STATUS", "ERROR_TEXT", "ERROR_CATEGORY", "RESULTS_UPDATED_DATE", "RECONCILIATION_STATUS", "SOURCE_REF", "DMT_REFERENCE", "FUSION_ID")  AS 
WITH tfm_lanes AS (
