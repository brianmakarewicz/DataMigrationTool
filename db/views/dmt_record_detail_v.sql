...
SELECT 'ARInvoices', 'AR Distributions',
       ...
       CAST(NULL AS VARCHAR2(400)),
       CAST(NULL AS VARCHAR2(400)),
       FUSION_CUST_TRX_LINE_GL_DIST_ID
