...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_RUN_RECORDS_V" (
    ...
    SELECT RUN_ID, WORK_QUEUE_ID, 'Suppliers', 'Suppliers', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_VENDOR_ID), ERROR_TEXT,
    ...
    SELECT RUN_ID, WORK_QUEUE_ID, 'SupplierAddresses', 'SupplierAddresses', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_PARTY_SITE_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    FROM   DMT_POZ_SUP_ADDR_TFM_TBL
    UNION ALL
    SELECT RUN_ID, WORK_QUEUE_ID, 'SupplierSites', 'SupplierSites', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_VENDOR_SITE_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    FROM   DMT_POZ_SUP_SITE_TFM_TBL
    UNION ALL
    SELECT RUN_ID, WORK_QUEUE_ID, 'SupplierSiteAssignments', 'SupplierSiteAssignments', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_ASSIGNMENT_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    FROM   DMT_POZ_SUP_SITE_ASSN_TFM_TBL
    UNION ALL
    SELECT RUN_ID, WORK_QUEUE_ID, 'SupplierContacts', 'SupplierContacts', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_CONTACT_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    ...
    SELECT RUN_ID, WORK_QUEUE_ID, 'PurchaseOrders',
           ...
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_PO_HEADER_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    ...
    SELECT RUN_ID, WORK_QUEUE_ID, 'APInvoices',
           ...
           OPERATING_UNIT,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_INVOICE_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    FROM   DMT_AP_INVOICES_INT_TFM_TBL
    UNION ALL
    -- ---- Customers (C005) ----
    SELECT RUN_ID, WORK_QUEUE_ID, 'Customers', 'Customers', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_CUST_ACCOUNT_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    ...
    SELECT RUN_ID, WORK_QUEUE_ID, 'ARInvoices',
           ...
           CASE WHEN BU_NAME IS NOT NULL
               THEN BU_NAME || CASE WHEN BATCH_SOURCE_NAME IS NOT NULL
                   THEN ':' || BATCH_SOURCE_NAME END
               END,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_CUSTOMER_TRX_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    FROM   DMT_RA_LINES_TFM_TBL
    UNION ALL
    -- ---- GL Balances ----
    SELECT RUN_ID, WORK_QUEUE_ID, 'GLBalances', 'GLBalances', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_JE_HEADER_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    FROM   DMT_GL_INTERFACE_TFM_TBL
    UNION ALL
    -- ---- GL Budget Balances ----
    SELECT RUN_ID, WORK_QUEUE_ID, 'GLBudgets', 'GLBudgets', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_BUDGET_VERSION_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    ...
    SELECT RUN_ID, WORK_QUEUE_ID, 'Projects', 'Projects', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_PROJECT_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    ...
    SELECT RUN_ID, WORK_QUEUE_ID, 'ParticipantEnrollments', 'ParticipantEnrollments', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_PARTICIPANT_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    ...
    SELECT RUN_ID, WORK_QUEUE_ID, 'DependentEnrollments', 'DependentEnrollments', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_DEPENDENT_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    ...
    SELECT RUN_ID, WORK_QUEUE_ID, 'BeneficiaryDesignations', 'BeneficiaryDesignations', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_BENEFICIARY_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    FROM   DMT_BEN_BENFY_TFM_TBL
    UNION ALL
    -- ---- HCM: Tax Cards ----
    SELECT RUN_ID, WORK_QUEUE_ID, 'TaxCards', 'TaxCards', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_DIR_CARD_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    FROM   DMT_TAX_CARD_TFM_TBL
    UNION ALL
    -- ---- HCM: Talent Profiles ----
    SELECT RUN_ID, WORK_QUEUE_ID, 'TalentProfiles', 'TalentProfiles', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_PROFILE_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    ...
    SELECT RUN_ID, WORK_QUEUE_ID, 'PerformanceDocuments', 'PerformanceDocuments', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_EVALUATION_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
    FROM   DMT_PERF_EVAL_TFM_TBL
    UNION ALL
    -- ---- HCM: Work Schedules ----
    SELECT RUN_ID, WORK_QUEUE_ID, 'WorkSchedules', 'WorkSchedules', NULL,
           TFM_SEQUENCE_ID, RECON_KEY, TFM_STATUS, TO_CHAR(FUSION_SCHEDULE_ID), ERROR_TEXT,
           DMT_REF_ID_PKG.BUILD_REF(RUN_ID, WORK_QUEUE_ID, TFM_SEQUENCE_ID)
