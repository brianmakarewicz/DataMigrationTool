...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_PIPELINE_SUMMARY_V" ("RUN_ID", "SCENARIO_ID", "PIPELINE_CODES", "SCENARIO_NAME", "PREFIX", "SUBMITTED_DATE", "COMPLETED_DATE", "RUN_STATUS", "PIPELINE", "OBJECT_TYPE", "SORT_ORDER", "OBJECT_STATUS", "TOTAL_ROWS", "LOADED_ROWS", "FAILED_ROWS", "GENERATED_ROWS", "IN_PROGRESS_ROWS", "UNRECONCILED_ROWS", "CARD_SUMMARY", "CARD_CSS_CLASS", "LOAD_ESS_JOB_ID", "IMPORT_ESS_JOB_ID", "POSTRUN_ESS_JOB_ID", "ZIP_FILENAME")  AS 
