...
CREATE OR REPLACE EDITIONABLE VIEW "DMT_V_GRANT_ORG_CREDITS_DETAIL" ("RUN_STATUS", "ERROR_TEXT", "RECONCILIATION_STATUS", "AWARD_NUMBER", "PROJECT_NUMBER", "ORGANIZATION", "CREDIT_PERCENTAGE", "SOURCE_ID", "STG_SEQUENCE_ID", "RUN_ID", "PREFIX", "SCENARIO_ID", "STAGE_DATE", "LAST_UPDATED_DATE")  AS 
  SELECT
