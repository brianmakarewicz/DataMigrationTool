...
begin
  execute immediate 'CREATE INDEX "DMT_PJF_PROJECTS_STG_TBL_N1" ON "DMT_PJF_PROJECTS_STG_TBL" ("STATUS")';
exception when others then
...
COMMENT ON COLUMN "DMT_PJF_PROJECTS_STG_TBL"."STATUS" IS 'NEW > TRANSFORMED > LOADED / FAILED. RETRY = user override for selective reprocess.';
