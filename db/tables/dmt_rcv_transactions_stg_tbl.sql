...
begin
  execute immediate 'CREATE INDEX "DMT_RCV_TXN_STG_N1" ON "DMT_RCV_TRANSACTIONS_STG_TBL" ("STATUS")';
exception when others then
...
COMMENT ON COLUMN "DMT_RCV_TRANSACTIONS_STG_TBL"."STATUS" IS 'NEW > TRANSFORMED > LOADED / FAILED. RETRY = user override for selective reprocess.';
