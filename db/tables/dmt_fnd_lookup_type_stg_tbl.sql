...
begin
  execute immediate 'CREATE TABLE "DMT_FND_LOOKUP_TYPE_STG_TBL" 
   (	"STG_SEQUENCE_ID" NUMBER DEFAULT DMT_FND_LOOKUP_TYPE_STG_SEQ.NEXTVAL NOT NULL ENABLE, 
...
begin
  select nullable into l_nullable from user_tab_columns
   where table_name = 'DMT_FND_LOOKUP_TYPE_STG_TBL' and column_name = 'STG_STATUS';
