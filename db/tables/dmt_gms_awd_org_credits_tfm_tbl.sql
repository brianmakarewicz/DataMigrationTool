...
begin
  execute immediate 'CREATE TABLE "DMT_GMS_AWD_ORG_CREDITS_TFM_TBL" 
   (	"TFM_SEQUENCE_ID" NUMBER DEFAULT DMT_GMS_AWD_ORGCR_TFM_SEQ.NEXTVAL NOT NULL ENABLE, 
...
/
COMMENT ON COLUMN "DMT_GMS_AWD_ORG_CREDITS_TFM_TBL"."WORK_QUEUE_ID" IS 'The work queue item (DMT_WORK_QUEUE_TBL.QUEUE_ID) that processed this record. FK in _foreign_keys.sql. Stamped at generation; unit of per-work-item processing (design section 7, accepted 2026-07-20).';
