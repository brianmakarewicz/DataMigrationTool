...
begin
  execute immediate 'CREATE TABLE "DMT_POZ_SUP_SITE_TFM_TBL" 
   (	"TFM_SEQUENCE_ID" NUMBER DEFAULT DMT_OWNER.DMT_POZ_SUP_SITE_TFM_ID_SEQ.NEXTVAL NOT NULL ENABLE, 
...
COMMENT ON COLUMN "DMT_POZ_SUP_SITE_TFM_TBL"."TFM_SEQUENCE_ID" IS 'PK - from DMT_POZ_SUP_SITE_TFM_ID_SEQ';
