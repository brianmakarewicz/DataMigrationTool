...
begin
  execute immediate 'CREATE TABLE "DMT_PJF_PROJECTS_TFM_TBL" 
   (	"TFM_SEQUENCE_ID" NUMBER DEFAULT DMT_OWNER.DMT_PJF_PROJECTS_TFM_SEQ.NEXTVAL NOT NULL ENABLE, 
...
COMMENT ON COLUMN "DMT_PJF_PROJECTS_TFM_TBL"."TFM_SEQUENCE_ID" IS 'PK - from DMT_PJF_PROJECTS_TFM_SEQ';
