...
begin
  ...
  where  table_name = 'ERR$_DMT_CE_BANK_ACCT_STG_TBL' and column_name = 'STATUS';
  if l_n = 1 then
    execute immediate 'ALTER TABLE "ERR$_DMT_CE_BANK_ACCT_STG_TBL" RENAME COLUMN "STATUS" TO "STG_STATUS"';
  end if;
end;
/
