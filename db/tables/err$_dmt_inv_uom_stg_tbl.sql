-- ERR$_DMT_INV_UOM_STG_TBL (generated from ATP 2026-07-03)

begin
  execute immediate 'CREATE TABLE "ERR$_DMT_INV_UOM_STG_TBL" 
...
begin
  ...
  where  table_name = 'ERR$_DMT_INV_UOM_STG_TBL' and column_name = 'STATUS';
  if l_n = 1 then
    execute immediate 'ALTER TABLE "ERR$_DMT_INV_UOM_STG_TBL" RENAME COLUMN "STATUS" TO "STG_STATUS"';
  end if;
end;
/
