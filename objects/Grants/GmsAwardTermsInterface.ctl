		 --  This control file loads projects data from a CSV file into a staging/interface table GMS_AWARD_TERMS_INT. 
...
LOAD DATA
	INFILE GmsAwardTermsInterface.csv
   	APPEND
   	INTO TABLE GMS_AWARD_TERMS_INT
	FIELDS TERMINATED BY ','
	OPTIONALLY ENCLOSED BY '"'
   	TRAILING NULLCOLS
		( 	AWARD_TERM_INTERFACE_ID					expression "GMS_AWARD_TERMS_INTERFACE_S.nextval",
